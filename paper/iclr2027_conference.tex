...
task. A longer-span LeWM planner does not reproduce these gains,
highlighting better evaluation of candidate actions---not simply longer
CEM search---as the key to long-range control.
\end{abstract}
