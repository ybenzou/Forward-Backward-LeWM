...
At every offset beyond $H=25$, all three HAS runs exceed the fixed
LeWM reference: $27$ of $27$ run-level comparisons are positive, with
the smallest margin $3.2$ percentage points (Reacher, $o=50$).
The between-run spread is largest for TwoRoom at $o=100$
($72.33\pm8.71\%$), so the result indicates persistence of the
observed advantage rather than uniform success rates.
