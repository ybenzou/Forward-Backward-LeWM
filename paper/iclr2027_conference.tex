...
on PushT, TwoRoom, and Reacher across three training seeds per task and
ten paired evaluation seeds per trained model show that HAS improves
mean success at every tested goal distance beyond LeWM's default
planning span. Comparisons with a tested longer-span planner and fixed
extension depths further show that neither simply increasing the action
horizon nor applying a constant amount of temporal extension can
consistently reproduce these gains.
