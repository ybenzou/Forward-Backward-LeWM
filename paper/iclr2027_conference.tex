...
For a later goal at offset $o$, HAS applies the shared action-free
latent predictor across the remaining action blocks and evaluates the
extended representation against the goal embedding. The diagram depicts
