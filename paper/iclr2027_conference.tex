...
cross-entropy method (CEM) to optimize action sequences: sampled
candidates are rolled out through the latent predictor and ranked by
the distance between their predicted endpoints and a goal image.
...
endpoints with $P$, and scores their recursively extended
representations.
